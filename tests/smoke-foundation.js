...
async function main() {
  ...
  assert(window.DashboardHome.renderMainHome().includes("home-summary-panel"), "DashboardHome.renderMainHome failed");
  assert(window.DashboardHome.renderGuruHome().includes("home-summary-panel"), "DashboardHome.renderGuruHome failed");
  assert(window.DashboardHome.renderKoordinatorHome(["7", "8"]).includes("home-summary-panel"), "DashboardHome.renderKoordinatorHome failed");
  ...
  assert(homeContent.innerHTML.includes("home-summary-panel"), "DashboardHome.renderHomePage failed");
