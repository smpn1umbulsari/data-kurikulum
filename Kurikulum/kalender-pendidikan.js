(function initKalenderPendidikanModule(global) {
  ...
  function renderKalenderPendidikanPage() {
    ...
    return `
      <div class="card kalender-module-panel">
        <div class="kalender-module-header">
          <div>
            <span class="dashboard-eyebrow">Kurikulum</span>
            <h2>Kalender Pendidikan</h2>
            <p class="kalender-module-description">Kelola tanggal tetap, hari penting pendidikan, dan agenda sekolah. Hanya item yang aktif yang akan masuk ke kalender pendidikan.</p>
          </div>
          <div class="kalender-toolbar-actions">
