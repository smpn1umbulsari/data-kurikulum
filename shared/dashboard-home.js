(function initDashboardHome(global) {
  ...
  function renderGuruHomePage(options = {}) {
    if (options.pageTitle) options.pageTitle.innerText = "Dashboard";
  ...
  function renderHomePageShell(context) {
    return renderCleanDashboardIntro(context);
  }
  ...
  function renderGuruHomePage(options = {}) {
    ...
    applyHomeSnapshot(context);
    options.loadHomeStats?.(loadOptions);
  }
  ...
  async function loadHomeStats(options = {}) {
    ...
    const setText = (id, value) => {
      if (global.AppDom?.setText) {
        global.AppDom.setText(id, value);
        return;
      }
