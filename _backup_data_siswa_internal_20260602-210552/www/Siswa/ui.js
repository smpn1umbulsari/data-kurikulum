  ...
  return `
    <tr data-siswa-nipd="${safeNipd}">
      ...
      <td class="siswa-col-aksi">
        <div class="table-actions siswa-row-actions">
        ${d.nipd ? `
          <button class="btn-secondary btn-table-compact siswa-edit-btn" onclick="editRow('${safeNipdJs}')">
            Edit
          </button>
        ` : `
          <button class="btn-secondary btn-table-compact siswa-edit-btn" disabled>
            Edit
          </button>
        `}

        <button class="btn-danger btn-table-compact siswa-delete-btn" onclick="hapusData('${safeNipdJs}')">
          Hapus
        </button>
        </div>
      </td>
